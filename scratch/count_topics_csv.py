...
skip_words_upper = ["YEAR", "WEEK", "TOPIC", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER", 
                    ...
                    "DECEMBER 2025", "OCTOBER 2025", "SEPTEMBER 2025", 
                    "JAN 2026", "FEB 2026", "MAR 2026", "APR 2026", "MAY 2026", "JAN 2025", "FEB 2025",
                    "DECEMBER", "September", "October", "November", "December", "January", "February", "March", "April", "May"]
...
print(f"Total topics parsed: {len(parsed_items)}")
from collections import Counter
year_counter = Counter([item['year'] for item in parsed_items])
for y, count in sorted(year_counter.items()):
    print(f"Year Block: {y:<30} | Topics Count: {count}")
